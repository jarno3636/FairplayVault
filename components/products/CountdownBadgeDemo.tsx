...
export default function CountdownBadgeDemo() {
  // demo: 2 minutes from now
  const to = Math.floor(Date.now()/1000) + 120
  return (
    <ProductCard
      title="Countdown Badge"
      subtitle="Tiny, pulse-on-urgent badge to show time left."
      demo={<CountdownBadge to={to} />}
      code={code}
    />
  )
}
